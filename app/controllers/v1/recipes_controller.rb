class V1::RecipesController < ApplicationController
  ...
  def api_search
    ...
    url = "https://api.edamam.com/search?q=#{params[:ingredients]}&app_id=c2e953ab&app_key=28bae3bac65b4eb1f5e5a7ab4989ae11&from=0&to=14&calories=#{params[:min_calories]}-#{params[:max_calories]}&ingr=#{params[:max_ingredients]}&excluded=#{params[:excluded]}"
